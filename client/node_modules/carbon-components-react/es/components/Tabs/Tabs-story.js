...
storiesOf('Tabs', module).addDecorator(withKnobs).add('Default', function () {
  return React.createElement(Tabs, props.tabs(), React.createElement(Tab, _extends({
  ...
  }, "Content for first tab goes here.")), React.createElement(Tab, _extends({
    id: "tab-2"
  }, props.tab(), {
    label: "Tab label 2"
  }), React.createElement("div", {
    className: "some-content"
  }, "Content for second tab goes here.")), React.createElement(Tab, _extends({
    id: "tab-3"
  }, props.tab(), {
    label: "Tab label 3",
    disabled: true
    ...
    className: "some-content"
  }, "Content for third tab goes here.")), React.createElement(Tab, _extends({
    id: "tab-4"
  }, props.tab(), {
    label: "Tab label 4",
    ...
    className: "some-content"
  }, "Content for fourth tab goes here.")), React.createElement(Tab, _extends({
    id: "tab-5"
  }, props.tab(), {
