...
function ProgressStep(_ref) {
  ...
  var SVGIcon = function SVGIcon(_ref2) {
    ...
    if (current) {
      return _react.default.createElement(_iconsReact.CircleFilled16, null, _react.default.createElement("title", null, description));
    }
    ...
    return _react.default.createElement(_iconsReact.RadioButton16, null, _react.default.createElement("title", null, description));
  };
  ...
  }, message), _react.default.createElement(SVGIcon, {
    complete: complete,
    current: current,
...
function (_Component) {
  ...
  _createClass(ProgressIndicator, [{
    ...
    value: function render() {
      ...
      var classes = (0, _classnames4.default)((_classnames3 = {}, _defineProperty(_classnames3, "".concat(prefix, "--progress"), true), _defineProperty(_classnames3, "".concat(prefix, "--progress--vertical"), vertical), _defineProperty(_classnames3, className, className), _classnames3));
