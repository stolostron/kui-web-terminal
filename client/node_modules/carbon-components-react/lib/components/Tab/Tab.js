...
function (_React$Component) {
  ...
  _createClass(Tab, [{
    ...
    value: function render() {
      ...
      }, _defineProperty(_anchorProps, 'aria-selected', selected), _defineProperty(_anchorProps, 'aria-disabled', disabled), _defineProperty(_anchorProps, 'aria-controls', id && "".concat(id, "__panel")), _defineProperty(_anchorProps, "ref", function ref(e) {
        _this.tabAnchor = e;
      }), _anchorProps);
