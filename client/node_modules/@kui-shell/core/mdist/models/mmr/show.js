 ...
 *
 */
export function formatForTab(tab, mmr, resource) {
...
export function show(tab, mmr) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const content = hasContent(defaultMode) ? yield renderContent(tab, mmr, defaultMode) : undefined;
