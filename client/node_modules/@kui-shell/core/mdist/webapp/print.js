 ...
 *
 */
export const streamTo = (tab, block) => {
 ...
 *
 */
export const printResults = (block, nextBlock, tab, resultDom, echo = true, execOptions, command, evaluator) => (response) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        if (response && response !== true) {
            if (yield renderResult(response, tab, resultDom, block, echo)) {
                ...
                if (echoOk || (execOptions && execOptions.type === ExecType.ClickHandler)) {
                    const { showCustom } = yield import('./views/sidecar');
                    yield showCustom(tab, response, isPopup() ? Object.assign({}, execOptions, { leaveBottomStripeAlone: true }) : execOptions, customContainer);
                    if (echoOk && !isPopup()) {
