...
exports.formatOneRowResult = (tab, options = {}) => (entity) => {
...
const udpateTheRow = (newRow, updateIndex, existingTable) => (tab, option) => {
    const newRowView = exports.formatOneRowResult(tab, option)(newRow);
...
const insertTheRow = (newRow, insertBeforeIndex, existingTable, block) => (tab, option) => {
    const newRowView = exports.formatOneRowResult(tab, option)(newRow);
...
exports.formatTable = (tab, response, resultDom, options = {}) => {
    ...
    const format = (table) => {
        ...
        const rows = prepareRows.map(exports.formatOneRowResult(tab, formatRowOption));
        const rowFrag = document.createDocumentFragment();
    ...
    if (watchable_1.isWatchable(response)) {
        ...
        const update = (newRow) => {
            ...
            if (foundIndex === -1) {
                ...
                if (doUpdate)
                    udpateTheRow(newRow, foundIndex, existingTable)(tab, formatRowOption);
            }
        };
        const header = (header) => {
            const existingRows = existingTable.rowsModel;
