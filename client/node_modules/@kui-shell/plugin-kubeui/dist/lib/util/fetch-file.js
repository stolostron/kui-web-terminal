...
const debug = debug_1.default('plugin-kubeui/util/fetch-file');
function needle(tab, method, url) {
    return __awaiter(this, void 0, void 0, function* () {
        if (core_1.isHeadless()) {
            ...
            const { net } = (yield Promise.resolve().then(() => require('electron'))).remote;
...
function fetchFileString(tab, url) {
    return __awaiter(this, void 0, void 0, function* () {
...
exports.default = fetchFileString;
