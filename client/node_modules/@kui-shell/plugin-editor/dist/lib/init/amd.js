...
const language_scan_1 = require("../language-scan");
            ...
            if (typeof AMDLoader === 'undefined') {
                ...
                const initEditor = () => {
                    if (!initDone) {
                        ...
                        language_scan_1.default(global['monaco'].languages).forEach(({ language, provider }) => {
                            global['monaco'].languages.registerCompletionItemProvider(language, provider);
                        });
                        global['define'] = undefined;
                        initDone = true;
                    }
                    editor = global['monaco'].editor.create(editorWrapper, Object.assign(defaults_1.default(options), options));
                    resolve(editor);
                };
