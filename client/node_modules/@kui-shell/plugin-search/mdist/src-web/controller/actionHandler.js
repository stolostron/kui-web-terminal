...
exports.deleteResource = function (args) { return new Promise(function (resolve, reject) {
    ...
    HTTPClient_1["default"]('post', 'console', search_queries_1.DELETE_RESOURCE(args.argv[1], args.argv[2], args.argv[3], args.argv[4], args.argv[5]))
        .then(function (res) {
        resolve(res.errors
