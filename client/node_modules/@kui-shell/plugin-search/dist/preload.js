...
var InputWrapper_1 = require("./src-web/components/InputWrapper");
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                if (core_1.inBrowser()) {
                    fetch('/multicloud/search').then(function (page) { return page.text(); }).then(function (data) {
                ...
                return [4 /*yield*/, InputWrapper_1.InputWrapper(stripe)
            ...
            case 1:
                ...
                prompt = document.querySelector('.repl-block .repl-input input');
                cli_1.listen(prompt);
                return [2 /*return*/];
        }
    });
