...
import { i18n, i18nFromMap, theme, config, inBrowser, injectCSS, Presentation } from '@kui-shell/core';
...
function renderAbout() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const openHome = () => __awaiter(this, void 0, void 0, function* () {
            return inBrowser()
                ? window.open(home)
                : (yield import(/* webpackChunkName: "electron" */ /* webpackMode: "lazy" */ './electron-helpers')).openExternal(home);
        });
        if (license) {
            badges.push(license);
        }
...
const aboutWindow = (args) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const name = theme.productName ||
        (!inBrowser() &&
            (yield import(/* webpackChunkName: "electron" */ /* webpackMode: "lazy" */ './electron-helpers')).getAppName());
    ...
    const modes = standardModes.concat(theme.about || []);
    modes.find(_ => _.mode === defaultMode).defaultMode = true;
    return {
        type: 'custom',
        prettyType: 'about',
        presentation: (document.body.classList.contains('subwindow') && Presentation.SidecarFullscreen) || Presentation.SidecarThin,
        modes,
        metadata: {
            name
        },
