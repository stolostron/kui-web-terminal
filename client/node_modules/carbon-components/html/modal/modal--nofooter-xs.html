...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-o7vxhrfrazj">Show
  modal</button>

<div data-modal id="modal-o7vxhrfrazj" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-o7vxhrfrazj-label" aria-describedby="modal-o7vxhrfrazj-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--xs">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-o7vxhrfrazj-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-o7vxhrfrazj-heading">Modal heading</p>
