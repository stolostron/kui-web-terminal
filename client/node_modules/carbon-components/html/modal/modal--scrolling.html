...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-d8ed3vhdr77">Show
  modal</button>

<div data-modal id="modal-d8ed3vhdr77" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-d8ed3vhdr77-label" aria-describedby="modal-d8ed3vhdr77-heading" tabindex="-1">
  <div class="bx--modal-container">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-d8ed3vhdr77-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-d8ed3vhdr77-heading">Modal heading</p>
