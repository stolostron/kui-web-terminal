...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-uaun0yt4jmf">Show
  modal</button>

<div data-modal id="modal-uaun0yt4jmf" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-uaun0yt4jmf-label" aria-describedby="modal-uaun0yt4jmf-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--xs">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-uaun0yt4jmf-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-uaun0yt4jmf-heading">Modal heading</p>
