...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-njovfhx1u9o">Show
  modal</button>

<div data-modal id="modal-njovfhx1u9o" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-njovfhx1u9o-label" aria-describedby="modal-njovfhx1u9o-heading" tabindex="-1">
  <div class="bx--modal-container">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-njovfhx1u9o-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-njovfhx1u9o-heading">Modal heading</p>
