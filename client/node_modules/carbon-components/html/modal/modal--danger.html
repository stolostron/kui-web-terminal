...
<button class="bx--btn bx--btn--danger" type="button" data-modal-target="#modal-v0tvwmouc8f">Show
  modal</button>

<div data-modal id="modal-v0tvwmouc8f" class="bx--modal bx--modal--danger" role="dialog"
  aria-modal="true" aria-labelledby="modal-v0tvwmouc8f-label" aria-describedby="modal-v0tvwmouc8f-heading" tabindex="-1">
  <div class="bx--modal-container">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-v0tvwmouc8f-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-v0tvwmouc8f-heading">Modal heading</p>
