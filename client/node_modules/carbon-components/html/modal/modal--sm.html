...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-eoygfn12mba">Show
  modal</button>

<div data-modal id="modal-eoygfn12mba" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-eoygfn12mba-label" aria-describedby="modal-eoygfn12mba-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--sm">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-eoygfn12mba-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-eoygfn12mba-heading">Modal heading</p>
