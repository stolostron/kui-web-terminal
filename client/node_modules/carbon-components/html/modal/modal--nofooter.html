...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-mft573cpvsd">Show
  modal</button>

<div data-modal id="modal-mft573cpvsd" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-mft573cpvsd-label" aria-describedby="modal-mft573cpvsd-heading" tabindex="-1">
  <div class="bx--modal-container">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-mft573cpvsd-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-mft573cpvsd-heading">Modal heading</p>
