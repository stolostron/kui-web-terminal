...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-nwpyitxmiyl">Show
  modal</button>

<div data-modal id="modal-nwpyitxmiyl" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-nwpyitxmiyl-label" aria-describedby="modal-nwpyitxmiyl-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--sm">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-nwpyitxmiyl-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-nwpyitxmiyl-heading">Modal heading</p>
