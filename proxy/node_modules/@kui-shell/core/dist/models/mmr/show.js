...
function formatForTab(tab, mmr, resource) {
    return __awaiter(this, void 0, void 0, function* () {
        if (!content_types_1.hasContent(resource)) {
            ...
            return formatForTab(tab, mmr, yield resource.content(tab, mmr));
        }
        ...
        if (content_types_1.isStringWithOptionalContentType(content)) {
            ...
            if (!content_types_1.isScalarContent(actualContent)) {
                if (table_1.isTable(actualContent)) {
                    return {
                        content: yield wrapTable(tab, actualContent)
                    };
                }
                else {
                    return {
            ...
            if (table_1.isTable(content.content)) {
                return {
                    content: yield wrapTable(tab, content.content)
                };
            }
            else {
                return content;
            ...
            return {
                content: yield wrapTable(tab, content)
            };
        }
...
function show(tab, mmr) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const modesWithButtons = bottom_stripe_1.addModeButtons(tab, ourModesWithButtons, mmr, {
        ...
        const content = content_types_1.hasContent(defaultMode) ? yield renderContent(tab, mmr, defaultMode) : undefined;
        bottom_stripe_1.addModeButtons(tab, ourModesWithButtons, mmr, {
            preserveBackButton: true,
            show: mmr.defaultMode
        });
        if (content) {
