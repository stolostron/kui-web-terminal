...
export const inBottomInputMode = typeof document !== 'undefined' && document.body.classList.contains('kui--bottom-input');
export function uiThemes() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        // dependence cycle
        const { prescanModel } = yield import('../plugins/plugins');
