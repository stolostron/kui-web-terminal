 ...
 *
 */
export declare const oops: (command: string, block?: HTMLElement, nextBlock?: HTMLElement) => (err: UsageError | Error | CodedError<number> | HideError | PopupError) => Promise<boolean>;
