...
TableExpandHeader.propTypes = {
   ...
   * focused
   */
  ariaLabel: (0, _requiredIfGivenPropExists.default)('enableExpando', _propTypes.default.string),

  /**
   * Specify whether this row is expanded or not. This helps coordinate data
   * attributes so that `TableExpandRow` and `TableExapndedRow` work together
   */
  isExpanded: (0, _requiredIfGivenPropExists.default)('enableExpando', _propTypes.default.bool),

  /**
   * Hook for when a listener initiates a request to expand the given row
   */
  onExpand: (0, _requiredIfGivenPropExists.default)('enableExpando', _propTypes.default.func),
