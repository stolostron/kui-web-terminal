...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-pnm3rsof3qe">Show
  modal</button>

<div data-modal id="modal-pnm3rsof3qe" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-pnm3rsof3qe-label" aria-describedby="modal-pnm3rsof3qe-heading" tabindex="-1">
  <div class="bx--modal-container">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-pnm3rsof3qe-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-pnm3rsof3qe-heading">Modal heading</p>
