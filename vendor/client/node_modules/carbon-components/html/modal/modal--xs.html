...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-nmgq5t7nxnh">Show
  modal</button>

<div data-modal id="modal-nmgq5t7nxnh" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-nmgq5t7nxnh-label" aria-describedby="modal-nmgq5t7nxnh-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--xs">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-nmgq5t7nxnh-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-nmgq5t7nxnh-heading">Modal heading</p>
