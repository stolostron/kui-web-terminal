...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-3gb4x5d7fyl">Show
  modal</button>

<div data-modal id="modal-3gb4x5d7fyl" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-3gb4x5d7fyl-label" aria-describedby="modal-3gb4x5d7fyl-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--lg">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-3gb4x5d7fyl-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-3gb4x5d7fyl-heading">Modal heading</p>
