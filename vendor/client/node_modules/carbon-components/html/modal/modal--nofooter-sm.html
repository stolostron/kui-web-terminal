...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-gd4kagt4rme">Show
  modal</button>

<div data-modal id="modal-gd4kagt4rme" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-gd4kagt4rme-label" aria-describedby="modal-gd4kagt4rme-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--sm">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-gd4kagt4rme-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-gd4kagt4rme-heading">Modal heading</p>
