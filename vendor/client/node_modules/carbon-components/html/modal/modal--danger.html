...
<button class="bx--btn bx--btn--danger" type="button" data-modal-target="#modal-a1sz6s4kso4">Show
  modal</button>

<div data-modal id="modal-a1sz6s4kso4" class="bx--modal bx--modal--danger" role="dialog"
  aria-modal="true" aria-labelledby="modal-a1sz6s4kso4-label" aria-describedby="modal-a1sz6s4kso4-heading" tabindex="-1">
  <div class="bx--modal-container">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-a1sz6s4kso4-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-a1sz6s4kso4-heading">Modal heading</p>
