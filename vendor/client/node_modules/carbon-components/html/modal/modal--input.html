...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-ua37yrudhl">Show
  modal</button>

<div data-modal id="modal-ua37yrudhl" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-ua37yrudhl-label" aria-describedby="modal-ua37yrudhl-heading" tabindex="-1">
  <div class="bx--modal-container">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-ua37yrudhl-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-ua37yrudhl-heading">Modal heading</p>
    ...
    <div class="bx--modal-content bx--modal-content--with-form" >
      <div class="bx--form-item">
        <label for="text-input-ua37yrudhl" class="bx--label">Text Input label</label>
        <input id="text-input-ua37yrudhl" type="text" class="bx--text-input" placeholder="Optional placeholder text"
