...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-yrql0b10w1q">Show
  modal</button>

<div data-modal id="modal-yrql0b10w1q" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-yrql0b10w1q-label" aria-describedby="modal-yrql0b10w1q-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--sm">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-yrql0b10w1q-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-yrql0b10w1q-heading">Passive modal title as the message. Should be direct and 3 lines or less.</p>
