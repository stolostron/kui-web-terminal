...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-2xpwqq2gndi">Show
  modal</button>

<div data-modal id="modal-2xpwqq2gndi" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-2xpwqq2gndi-label" aria-describedby="modal-2xpwqq2gndi-heading" tabindex="-1">
  <div class="bx--modal-container">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-2xpwqq2gndi-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-2xpwqq2gndi-heading">Modal heading</p>
