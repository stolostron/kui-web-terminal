...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-cep5mzs1cki">Show
  modal</button>

<div data-modal id="modal-cep5mzs1cki" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-cep5mzs1cki-label" aria-describedby="modal-cep5mzs1cki-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--lg">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-cep5mzs1cki-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-cep5mzs1cki-heading">Modal heading</p>
