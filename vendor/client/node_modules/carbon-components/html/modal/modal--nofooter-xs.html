...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-hsylf9i246a">Show
  modal</button>

<div data-modal id="modal-hsylf9i246a" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-hsylf9i246a-label" aria-describedby="modal-hsylf9i246a-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--xs">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-hsylf9i246a-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-hsylf9i246a-heading">Modal heading</p>
