...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-ehyzl94epzi">Show
  modal</button>

<div data-modal id="modal-ehyzl94epzi" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-ehyzl94epzi-label" aria-describedby="modal-ehyzl94epzi-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--xs">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-ehyzl94epzi-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-ehyzl94epzi-heading">Passive modal title as the message. Should be direct and 3 lines or less.</p>
