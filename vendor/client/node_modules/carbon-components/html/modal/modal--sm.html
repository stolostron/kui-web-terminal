...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-kfvegzyastq">Show
  modal</button>

<div data-modal id="modal-kfvegzyastq" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-kfvegzyastq-label" aria-describedby="modal-kfvegzyastq-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--sm">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-kfvegzyastq-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-kfvegzyastq-heading">Modal heading</p>
