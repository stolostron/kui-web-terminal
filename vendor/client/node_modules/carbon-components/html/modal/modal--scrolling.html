...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-f38v9wgaoaj">Show
  modal</button>

<div data-modal id="modal-f38v9wgaoaj" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-f38v9wgaoaj-label" aria-describedby="modal-f38v9wgaoaj-heading" tabindex="-1">
  <div class="bx--modal-container">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-f38v9wgaoaj-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-f38v9wgaoaj-heading">Modal heading</p>
