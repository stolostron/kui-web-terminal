...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-phw3qjpyob">Show
  modal</button>

<div data-modal id="modal-phw3qjpyob" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-phw3qjpyob-label" aria-describedby="modal-phw3qjpyob-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--xs">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-phw3qjpyob-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-phw3qjpyob-heading">Passive modal title as the message. Should be direct and 3 lines or less.</p>
