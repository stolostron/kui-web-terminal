...
const registerCapability = () => __awaiter(void 0, void 0, void 0, function* () {
  ...
  (0, _HTTPClient.default)('get', 'svc', undefined).then(() => {
    (0, _pluginState.setPluginState)('enabled', true);

    if ((0, _pluginState.getPluginState)().enabled) {
    ...
    (0, _pluginState.setPluginState)('enabled', false);
    (0, _pluginState.setPluginState)('error', err);
  });
});
