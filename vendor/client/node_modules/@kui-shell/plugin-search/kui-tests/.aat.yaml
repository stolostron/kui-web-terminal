...
# Note: authToken for user mcmdev@us.ibm.com
authToken: 1364f334-0b01-44fc-ba77-b48558be6cce/e9764f3a-6efb-42b7-b8dc-e20ac4bde181
...
disable:
    # FIXME - Disabled these rules for the initial CI/CD integration.
    - 488
    - 495

# optional - Where the scan results should be saved.
# Default: results
outputFolder: ./test-output/a11y
