...
const clearedTerminalSelector = outputSelector + '.repl-active'
...
const failureOutputXtermSelector = failureSelector + ' .xterm-focus > div'

module.exports = { outputSelector, successSelector, resultInputSelector, failureSelector, failureOutputSelector, failureOutputXtermSelector, clearedTerminalSelector }
