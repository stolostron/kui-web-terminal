...
exports.cleanupTerminalAfterTermination = cleanupTerminalAfterTermination;
 ...
 *
 */
function cleanupTerminalAfterTermination(element) {
  const cursor = element.querySelector('.xterm-rows .xterm-cursor');
  const cursorRow = cursor && cursor.parentNode;
