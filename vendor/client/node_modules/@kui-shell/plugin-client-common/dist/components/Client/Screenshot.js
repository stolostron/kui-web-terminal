...
class Screenshot extends React.PureComponent {
  constructor(props) {
    ...
    _core.eventChannelUnsafe.on('/screenshot/element', element => {
        ...
        const listener = (event, buf) => {
          try {
            ...
            if (!buf) {
              ...
              this.setState({
                captured: nativeImage.createFromBuffer(buf),
  ...
  saveToDiskButton() {
    ...
    }, strings('Done')), React.createElement(_carbonComponentsReact.Button, {
      href: "#",
      size: "small",
      className: "screenshot-save-button",
  ...
  notification() {
    if (this.state && this.state.captured) {
      ...
      return React.createElement(_Alert.default, {
        ...
        src: this.state.captured.toDataURL(),
        className: "screenshot-image"
      })), React.createElement("div", {
        className: "kui--screenshot-captured-bottom-message"
