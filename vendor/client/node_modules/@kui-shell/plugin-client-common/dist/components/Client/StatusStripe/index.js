...
class StatusStripe extends React.PureComponent {
  ...
  screenshot() {
    const Screenshot = React.lazy(() => (0, _core.inElectron)() ? Promise.resolve().then(() => require('../Screenshot')) : Promise.resolve().then(() => require('../Empty')));
  ...
  render() {
    ...
    }, this.widgets(), this.screenshot(), React.createElement("div", {
