...
class PatternflyCard extends React.PureComponent {
  ...
  cardActions() {
    return React.createElement(_reactCore.CardActions, null, React.createElement(_reactCore.Dropdown, {
  ...
  header() {
    if (this.props.header || this.props.actions || this.props.icon) {
      return React.createElement(_reactCore.CardHeader, null, React.createElement(_reactCore.CardHeaderMain, null, this.props.header || this.props.icon && this.icon()), this.props.actions && this.cardActions());
    }
  }
  ...
  render() {
    ...
    }, React.Children.count(this.props.children) > 0 && React.createElement(React.Fragment, null, this.header(), this.title(), Array.isArray(this.props.children) ? this.props.children.map((child, idx) => React.createElement(_reactCore.CardBody, {
      key: idx
    }, child)) : React.createElement(_reactCore.CardBody, null, this.props.children)));
  }
