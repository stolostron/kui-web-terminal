...
function sameOptions(O1, O2) {
  ...
  let N2 = 0; // eslint-disable-next-line @typescript-eslint/no-unused-vars
...
function sameCommand(expectedArgvNoOptions, expectedParsedOptions, currentCwd) {
  return entry => {
    return entry && entry.cwd === currentCwd && sameArray(entry.argvNoOptions, expectedArgvNoOptions) && sameOptions(entry.parsedOptions, expectedParsedOptions);
  };
}