    ...
    render() {
        ...
        return (React.createElement("div", { className: "bx--data-table kui--data-table-as-grid", style: style }, response.body.map((kuiRow, kidx) => {
            ...
            return (React.createElement("span", { key: kidx, "data-tag": "badge", "data-entity-name": kuiRow.name },
                React.createElement("span", { title: title, "data-tag": "badge-circle", "data-just-updated": this.props.justUpdated[kuiRow.rowKey || kuiRow.name], className: css, onClick: onClickForCell(kuiRow, tab, repl, kuiRow.attributes.find(_ => _.onclick)) }, label)));
        })));
    }
}
