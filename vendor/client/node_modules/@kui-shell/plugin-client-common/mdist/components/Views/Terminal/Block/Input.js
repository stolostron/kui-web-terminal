...
import { isActive, isProcessing, isFinished, hasCommand, isEmpty, hasUUID, hasValue } from './BlockModel';
...
export default class Input extends InputProvider {
    ...
    dropdown() {
        if (!isActive(this.props.model)) {
            ...
            return (React.createElement(DropDown, { actions: actions, className: "kui--repl-block-right-element small-left-pad kui--toolbar-button-with-icon", onClose: this.props.willLoseFocus }));
        }
    }
    /**
