...
import { i18n, eventBus, eventChannelUnsafe, isPopup, isWatchable } from '@kui-shell/core';
import Block from './Block';
import getSize from './getSize';
import { Active, Finished, Cancelled, Processing, isActive, isProcessing, hasUUID } from './Block/BlockModel';
...
export default class ScrollableTerminal extends React.PureComponent {
    ...
    shouldPinTheBlock(event) {
        return (this.props.config.splitTerminals &&
