...
export default class Search extends React.PureComponent {
    ...
    stopFindInPage() {
        return __awaiter(this, void 0, void 0, function* () {
            return import('electron').then(({ remote }) => __awaiter(this, void 0, void 0, function* () {
    ...
    matchCount() {
        ...
        if (result) {
            ...
            return (React.createElement("span", { id: "search-found-text", className: "kui--search-match-count sub-text even-smaller-text nowrap" }, text));
        }
    }
    render() {
        if (!this.state.isActive || !inElectron()) {
            ...
            // re: id, text-search test needs this
            return (React.createElement("div", { className: "kui--search flex-layout", id: "search-bar" },
                React.createElement(CarbonSearch, { id: "search-input", placeHolderText: strings('placeHolderText'), small: true, labelText: "Search", onChange: this.onChange.bind(this), ref: this.doFocus.bind(this) }),
                this.matchCount()));
        }
    }
}
