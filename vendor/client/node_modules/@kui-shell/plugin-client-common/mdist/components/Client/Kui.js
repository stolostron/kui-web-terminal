...
export class Kui extends React.PureComponent {
    ...
    defaultSessionBehavior() {
        return !inBrowser()
            ? {}
            : {
                loading: React.createElement("div", { className: "kui--hero-text" }, "Connecting to your cloud..."),
                reinit: React.createElement("div", { className: "kui--hero-text" }, "Connection broken..."),
                loadingError: err => React.createElement("div", { className: "kui--hero-text" },
                    "Error connecting to your cloud: ",
                    err.toString()),
                loadingDone: (repl) => (React.createElement("span", null,
                    strings('Successfully connected to your cloud. For next steps, try this command: '),
                    ' ',
                    React.createElement("a", { href: "#", className: "bx--link", onClick: () => repl.pexec('getting started') }, "getting started")))
            };
    }
