...
const debug = (0, _debug.default)('core/main/headless-support');
debug('loading');
/**
...
const streamTo = () => __awaiter(void 0, void 0, void 0, function* () {
  const [{
    clearLine,
    cursorTo
  }, {
    print
  }] = yield Promise.all([Promise.resolve().then(() => require('readline')), Promise.resolve().then(() => require('./headless-pretty-print'))]);
