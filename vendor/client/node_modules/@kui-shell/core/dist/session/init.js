 ...
 *
 */
function initializeSession(tab) {
  return __awaiter(this, void 0, void 0, function* () {
    tab.state.ready = false;
    (0, _exec.getImpl)(tab);
    const promise = (0, _registrar.default)(tab);
    (0, _queueing.startInputQueueing)(tab);
    yield promise;
    tab.state.ready = true; // to test the session init error handling:
