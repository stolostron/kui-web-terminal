...
import { getCurrentContextName, onKubectlConfigChangeEvents, offKubectlConfigChangeEvents } from '@kui-shell/plugin-kubectl';
const strings = i18n('plugin-kubectl');
export default class CurrentContext extends React.PureComponent {
    constructor(props = {}) {
        super(props);
        this.handler = this.reportCurrentContext.bind(this);
        this.state = {
            text: '',
            viewLevel: 'hidden'
        };
    ...
    reportCurrentContext(idx) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                const context = yield getCurrentContextName(tab);
                this.setState({
