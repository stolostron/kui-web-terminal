...
function doList(args) {
  return __awaiter(this, void 0, void 0, function* () {
    ...
    if (preTables[0].length === 0) {
      ...
      return (0, _pluginKubectl.formatTable)('helm', 'get', undefined, args, preTables[0]);
    }
  });
}

var _default = registrar => {
  registrar.listen(`/${_commandPrefix.default}/helm/list`, doList);
  registrar.listen(`/${_commandPrefix.default}/helm/ls`, doList);
};
