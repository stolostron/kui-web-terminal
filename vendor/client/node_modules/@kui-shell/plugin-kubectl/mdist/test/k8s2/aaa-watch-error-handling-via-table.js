...
wdescribe(`kubectl watch error handler via table ${process.env.MOCHA_RUN_TARGET || ''}`, function () {
    ...
    const resultHasEmptyWatchText = (count, positive = true) => __awaiter(this, void 0, void 0, function* () {
        yield this.app.client.waitForExist(Selectors.OK_N(count), CLI.waitTimeout);
        const emptyWatchText = yield this.app.client.getText(Selectors.OK_N(count));
        if (positive) {
    ...
    it(`should watch pods, starting from an non-existent namespace`, () => __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            yield resultHasEmptyWatchText(watchResult.count);
            ...
            yield resultHasEmptyWatchText(watchResult.count, false);
            // delete the pod
...
//# sourceMappingURL=aaa-watch-error-handling-via-table.js.map