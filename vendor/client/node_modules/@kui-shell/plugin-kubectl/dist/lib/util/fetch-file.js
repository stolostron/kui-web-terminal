...
exports.fetchFileString = fetchFileString;
exports.fetchFileKustomize = fetchFileKustomize;
...
const debug = (0, _debug.default)('plugin-kubectl/util/fetch-file');
...
function needle({
  ...
  return __awaiter(this, void 0, void 0, function* () {
    if ((0, _core.isHeadless)()) {
      const needle = yield Promise.resolve().then(() => require('needle'));
      ...
      if (!(0, _core.hasProxy)()) {
        ...
        const body = yield qexec(`_fetchfile ${url}`);
      ...
      const {
        net
      } = (yield Promise.resolve().then(() => require('electron'))).remote;
      return new Promise((resolve, reject) => {
        ...
        request.on('response', response => {
          ...
          debug('got response', statusCode); // we will accumulate the body chunks below

          let body = ''; // Warning: you must register 'end' before 'data'.
...
function fetchFileString(repl, url) {
  return __awaiter(this, void 0, void 0, function* () {
    const files = yield fetchFile(repl, url);
    return files.map(_ => _.toString());
  });
}

function fetchFileKustomize(repl, url) {
  return __awaiter(this, void 0, void 0, function* () {
