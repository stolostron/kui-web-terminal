...
function command(tab, crd, args) {
  return __awaiter(this, void 0, void 0, function* () {
    return `${(0, _.getCommandFromArgs)(args)} get ${(0, _.fqn)(crd.apiVersion, (0, _core.encodeComponent)(crd.kind), (0, _core.encodeComponent)(crd.metadata.name), (0, _core.encodeComponent)(crd.metadata.namespace || (yield (0, _.getCurrentDefaultNamespace)(tab))))}`;
  });
}
/**
