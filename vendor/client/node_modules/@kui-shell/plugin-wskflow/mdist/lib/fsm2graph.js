...
export default function fsm2graph(tab, ir, containerElement, acts, options, rule
// eslint-disable-next-line @typescript-eslint/no-explicit-any
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const subtext = yield renderSubtext(tab, renderState.actions, renderState.activations, renderState.graphData, options);
        debug('subtext', subtext);
        debug('inserting DOM, calling graph2doms');
        const graph2doms = (yield import('./graph2doms')).default;
