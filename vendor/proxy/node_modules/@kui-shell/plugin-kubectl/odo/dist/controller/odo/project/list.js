...
function projectListView(args, response) {
  if (args.parsedOptions.o !== 'json' && (0, _pluginKubectl.isKubeResource)(response)) {
    ...
    return (0, _pluginKubectl.doExecWithRadioTable)(projects, defaultSelectedIdx, onSelectProject.bind(args.REPL), opts) || response;
  } else {
...
function getRawData(args) {
  ...
  return (0, _pluginKubectl.doExecWithStdout)(args, undefined, 'odo');
}
/** Fetch the KubeItems<Project> model */


function projectList(args) {
  return __awaiter(this, void 0, void 0, function* () {
    ...
    return Object.assign(list, {
      metadata: {
        name: args.command,
        namespace: yield (0, _pluginKubectl.getNamespace)(args)
      },
      modes: [],
      kuiRawData,
      isSimulacrum: true,
