 ...
 */
import { defaultFlags, commandPrefix, doGet, getNamespacesTransformer } from '@kui-shell/plugin-kubectl';
...
export default function registerOcProjectGet(registrar) {
    ...
    registrar.listen(`/${commandPrefix}/oc/get/project`, doGet('oc'), Object.assign({}, defaultFlags, { viewTransformer }));
    registrar.listen(`/${commandPrefix}/oc/get/projects`, doGet('oc'), Object.assign({}, defaultFlags, { viewTransformer }));
}
