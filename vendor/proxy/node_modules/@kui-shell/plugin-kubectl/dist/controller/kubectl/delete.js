...
var _default = registrar => {
  registrar.listen(`/${_commandPrefix.default}/kubectl/delete`, doDelete(), _flags.crudFlags);
  registrar.listen(`/${_commandPrefix.default}/k/delete`, doDelete(), _flags.crudFlags);
};
