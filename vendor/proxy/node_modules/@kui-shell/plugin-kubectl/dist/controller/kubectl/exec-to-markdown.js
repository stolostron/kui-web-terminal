...
function _default(args, exec) {
  return __awaiter(this, void 0, void 0, function* () {
    const cmd = args.argv[0] === _commandPrefix.default ? args.argv[1] : args.argv[0];
    const raw = yield (0, _exec.doExecWithStdout)(args, undefined, exec);
