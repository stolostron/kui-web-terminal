...
import { hasSingleOwnerReference } from '../../model/resource';
 ...
 *
 */
function command(tab, { metadata: { namespace, ownerReferences: [{ apiVersion, kind, name }] } }, args) {
...
const mode = {
    ...
    mode: {
        ...
        icon: React.createElement(Icons, { icon: "Up" }),
        command
    }
};
export default mode;
//# sourceMappingURL=ShowOwnerButton.js.map