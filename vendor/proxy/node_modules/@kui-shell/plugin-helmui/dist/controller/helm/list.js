...
function doList(args) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        return plugin_kubeui_1.formatTable('helm', 'get', undefined, args.parsedOptions, preTables[0]);
    });
}
exports.default = (registrar) => {
    registrar.listen(`/${command_prefix_1.default}/helm/list`, doList, {
        inBrowserOk: true
    });
    registrar.listen(`/${command_prefix_1.default}/helm/ls`, doList, {
        inBrowserOk: true
    });
};
