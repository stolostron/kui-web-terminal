...
describe('Tab completion core', function () {
    ...
    Common.localIt('should tab complete the ../../packages/core directory', () => tabby(this, `lls ${ROOT}/../../../packages/co`, `lls ${ROOT}/../../../packages/core/`));
    ...
    Common.localIt('should tab complete file with spaces non-unique', () => {
        return tabbyWithOptions(this, `lls ${join(tmp2.name, 'foo')}`, ['foo bar1', 'foo bar2'], `lls ${join(tmp2.name, 'foo\\ bar1')}`, { click: 0 });
    });
    Common.localIt('should tab complete file with spaces non-unique with dash option', () => {
        return tabbyWithOptions(this, `lls -l ${join(tmp2.name, 'foo')}`, ['foo bar1', 'foo bar2'], `lls -l ${join(tmp2.name, 'foo\\ bar1')}`, { click: 0 });
    });
    Common.localIt('should tab complete file with spaces non-unique with backslash escape', () => {
        return tabbyWithOptions(this, `lls ${join(tmp2.name, 'foo\\ ')}`, ['foo bar1', 'foo bar2'], `lls ${join(tmp2.name, 'foo\\ bar2')}`, { click: 1 });
    });
    ...
    Common.localIt('should complete on the single-entry directory', () => tabby(this, `lls ${ROOT}/data/core/core_single_entry_dir`, `lls ${ROOT}/data/core/core_single_entry_directory/`));
    // tab completion of a directory, auto-completing the single entry in the directory
    Common.localIt('should complete on the single-entry directory', () => tabby(this, `lls ${ROOT}/data/core/core_single_entry_directory/`, `lls ${ROOT}/data/core/core_single_entry_directory/only_one_file_here_please.js`));
    // tab completion of a dot file
    Common.localIt('should complete on a dot file', () => tabby(this, `lls ${ROOT}/data/core/.dot-file-for-`, `lls ${ROOT}/data/core/.dot-file-for-tests`));
    // tab completion with options, then click on the second (idx=1) entry of the expected cmpletion list
    Common.localIt('should tab complete local file path with options then click on second', () => tabbyWithOptions(this, `lls ${ROOT}/data/core/core_`, options, `lls ${ROOT}/data/core/core_single_entry_dir/`, {
        click: 1
    }));
    Common.localIt('should tab complete local file path with options, expect prompt update', () => tabbyWithOptions(this, `lls ${ROOT}/data/core/co`, options, `lls ${ROOT}/data/core/core_single_entry_dir/`, {
        click: 1,
    ...
    Common.localIt('should tab complete local file path with options then click on first', () => tabbyWithOptions(this, `lls ${ROOT}/data/core/core_test_directory_1/em`, fileOptions, `lls ${ROOT}/data/core/core_test_directory_1/empty1.js`, { click: 0 }));
    Common.localIt('should tab complete the data directory', () => tabby(this, `lls ${ROOT}/da`, `lls ${ROOT}/data/`));
    Common.localIt('should tab complete the data/core/empty.js file', () => tabby(this, `lls ${ROOT}/data/core/empty.js`, `lls ${ROOT}/data/core/empty.json`));
    // same, but this time tab to cycle through the options
    Common.localIt('should tab complete local file path', () => tabbyWithOptions(this, `lls ${ROOT}/data/core/core_`, options, `lls ${ROOT}/data/core/core_single_entry_dir/`, {
        nTabs: 1
    }));
    Common.localIt('should tab complete local file path, then options go away on edit', () => tabbyWithOptionsThenCancel(this, `lls ${ROOT}/data/core/core_`, options));
