...
function _fwrite(fullpath, data) {
    return __awaiter(this, void 0, void 0, function* () {
        const { writeFile } = yield import('fs');
 ...
 *
 */
const fwrite = ({ argvNoOptions, execOptions }) => __awaiter(void 0, void 0, void 0, function* () {
...
function fwriteTemp(args) {
    return __awaiter(this, void 0, void 0, function* () {
        const { mkTemp } = yield import('./mkTemp');
        const data = args.execOptions.data;
        const { content: tmp } = yield mkTemp();
...
//# sourceMappingURL=fwrite.js.map