...
import { eventChannelUnsafe, eventBus, inBrowser, ExecType, sameTab, disableInputQueueing } from '@kui-shell/core';
 ...
 *
 */
export const doExec = (tab, cmdline, argvNoOptions, parsedOptions, execOptions) => new Promise((resolve, reject) => {
    ...
    const exec = () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        try {
            ...
            const init = (ws) => __awaiter(void 0, void 0, void 0, function* () {
                const job = {
                    write: (data) => ws.send(JSON.stringify({ type: 'data', data, uuid: ourUUID })),
                    xon: () => {
                        debug('xon requested');
